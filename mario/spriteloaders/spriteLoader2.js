...
/*if (playerStats.currentLevel != level_0102.levelName){
...
game.viewPortConstructor(canvas.width, canvas.height,map,level_0102);
game.load_map(map,level_0102);
game.viewPortLim = true;

var Loop = function() {
game.update(map,level_0102);
game.draw(context,map,level_0102);

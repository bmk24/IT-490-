...
if (playerStats.currentLevel != level_0104.levelName){
...
game.viewPortConstructor(canvas.width, canvas.height,map,level_0104);
game.load_map(map,level_0104);
game.viewPortLim = true;

var Loop = function() {
game.update(map,level_0104);
game.draw(context,map,level_0104);

...
function init(){
  ...
  game.viewPortConstructor(canvas.width, canvas.height,map,level_0131);
  game.load_map(map,level_0131);
  game.viewPortLim = true;
  
  var Loop = function() {
  game.update(map,level_0131);
  game.draw(context,map,level_0131);

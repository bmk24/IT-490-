...
if (playerStats.currentLevel != level_0106.levelName){
...
game.viewPortConstructor(canvas.width, canvas.height,map,level_0106);
game.load_map(map,level_0106);
game.viewPortLim = true;

var Loop = function() {
game.update(map,level_0106);
game.draw(context,map,level_0106);

...
function init(){
  ...
  /*if (playerStats.currentLevel != level_0107.levelName){
  ...
  game.viewPortConstructor(canvas.width, canvas.height,map,level_0107);
  game.load_map(map,level_0107);
  game.viewPortLim = true;
  
  var Loop = function() {
  game.update(map,level_0107);
  game.draw(context,map,level_0107);

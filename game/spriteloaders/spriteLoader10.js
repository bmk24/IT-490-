...
function init(){
  ...
  if (playerStats.currentLevel != level_0110.levelName){
  ...
  game.viewPortConstructor(canvas.width, canvas.height,map,level_0110);
  game.load_map(map,level_0110);
  game.viewPortLim = true;
  
  var Loop = function() {
  game.update(map,level_0110);
  game.draw(context,map,level_0110);

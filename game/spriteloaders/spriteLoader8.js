...
function init(){
  ...
  if (playerStats.currentLevel != level_0108.levelName){
  ...
  game.viewPortConstructor(canvas.width, canvas.height,map,level_0108);
  game.load_map(map,level_0108);
  game.viewPortLim = true;
  
  var Loop = function() {
  game.update(map,level_0108);
  game.draw(context,map,level_0108);

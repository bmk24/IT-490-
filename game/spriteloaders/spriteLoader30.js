...
function init(){
  ...
  game.viewPortConstructor(canvas.width, canvas.height,map,level_0130);
  game.load_map(map,level_0130);
  game.viewPortLim = true;
  
  var Loop = function() {
  game.update(map,level_0130);
  game.draw(context,map,level_0130);

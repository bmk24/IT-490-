...
if (playerStats.currentLevel != level_0105.levelName){
...
game.viewPortConstructor(canvas.width, canvas.height,map,level_0105);
game.load_map(map,level_0105);
game.viewPortLim = true;

var Loop = function() {
game.update(map,level_0105);
game.draw(context,map,level_0105);

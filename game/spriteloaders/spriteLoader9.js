...
function init(){
  ...
  if (playerStats.currentLevel != level_0109.levelName){
  ...
  game.viewPortConstructor(canvas.width, canvas.height,map,level_0109);
  game.load_map(map,level_0109);
  game.viewPortLim = true;
  
  var Loop = function() {
  game.update(map,level_0109);
  game.draw(context,map,level_0109);
